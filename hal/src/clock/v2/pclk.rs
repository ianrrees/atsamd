...
mod imports {
    pub use crate::pac::gclk::pchctrl::GENSELECT_A;
    pub use crate::pac::gclk::PCHCTRL as CTRL;
}

#[cfg(feature = "has-sysctrl")]
mod imports {
    pub use crate::pac::gclk::clkctrl::GENSELECT_A;
...
#[path = "pclk/ids_d5x_e5x.rs"]
pub mod ids;

#[cfg(any(feature = "samd11", feature = "samd21"))]
#[path = "pclk/ids_d11_d21.rs"]
pub mod ids;
