...
mod imports {
    ...
    #[cfg(feature = "samd21")]
    pub use crate::gpio::{PA14 as XIn0Id, PA15 as XOut0Id};
    pub use crate::pac::sysctrl::{pclksr::R as STATUS_R, xosc::GAINSELECT_A, XOSC as XOSCCTRL};
...
#[cfg(feature = "has-sysctrl")]
impl From<Gain> for GAINSELECT_A {
    fn from(gain: Gain) -> Self {
        match gain {
            Gain::Zero => GAINSELECT_A::_0,
            Gain::One => GAINSELECT_A::_1,
            Gain::Two => GAINSELECT_A::_2,
            Gain::Three => GAINSELECT_A::_3,
            Gain::Four => GAINSELECT_A::_4,
        }
    }
}
